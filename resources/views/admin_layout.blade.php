...
<body>
                        ...
                        <li class="nav-item dropdown nav-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                                <div class="nav-user-info">
                                    <h5 class="mb-0 text-white nav-user-name">{{session('loggedInUser.Username')}}</h5>
                                    {{-- <span class="status"></span><span class="ml-2">Available</span> --}}
                                </div>
                                <a class="dropdown-item" href="#"><i class="fas fa-user mr-2"></i>Tài Khoản</a>
                                <a class="dropdown-item" href="{{route('logout')}}"><i class="fas fa-power-off mr-2"></i>Đăng xuất</a>
                            </div>
                        </li>
                    </ul>
                </div>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse"  aria-expanded="false" data-target="#submenu-1" aria-controls="submenu-1"><i class="fas fa-fw fa-table"></i>Sản Phẩm</a>
                                <div id="submenu-1" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{URL::to('/sanpham')}}">Quản Lý Sản Phẩm</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{URL::to('/sanphamct')}}">Chi Tiết Sản Phẩm</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{URL::to('/danhsachnhacungcap')}}"  aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2" ><i class="fa fa-fw fa-rocket"></i>Quản Lý Nhà Cung Cấp</a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{URL::to('/dsmau')}}"  aria-expanded="false" data-target="#submenu-3" aria-controls="submenu-3"><i class="fas fa-fw fa-chart-pie"></i>Quản Lý Màu</a>
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="{{URL::to('/danhsachdungluong')}}"  aria-expanded="false" data-target="#submenu-4" aria-controls="submenu-4" ><i class="fab fa-fw fa-wpforms"></i>Quản Lý Dung Lượng</a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse"  aria-expanded="false" data-target="#submenu-5" aria-controls="submenu-5"><i class="fas fa-fw fa-table"></i>Quản Lý Tài Khoản</a>
                                <div id="submenu-5" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{URL::to('/danhsachtknhanvien')}}">Tài Khoản Nhân Viên</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{URL::to('/danhsachtkkhachhang')}}">Tài Khoản Khách Hàng</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="{{URL::to('/danhsachchinhsach')}}"  aria-expanded="false" data-target="#submenu-4" aria-controls="submenu-4" ><i class="fab fa-fw fa-wpforms"></i>Quản Lý CSBH</a>
                            </li>
                            <li class="nav-item ">
                                <a class="nav-link" href="{{URL::to('/danhsachphieubaohanh')}}"  aria-expanded="false" data-target="#submenu-4" aria-controls="submenu-4" ><i class="fab fa-fw fa-wpforms"></i>Quản Lý Phiếu Bảo Hành</a>

                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{URL::to('/danhsachfeedback')}}"  aria-expanded="false" data-target="#submenu-6" aria-controls="submenu-6"><i class="fas fa-fw fa-file"></i> Quản Lý FeedBack </a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{URL::to('/dskhachhang')}}"  aria-expanded="false" data-target="#submenu-7" aria-controls="submenu-7"><i class="fas fa-fw fa-inbox"></i>Quản Lý Khách Hàng<span class="badge badge-secondary">New</span></a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-8" aria-controls="submenu-8"><i class="fas fa-fw fa-columns"></i>Quản Lý Hóa Đơn Bán</a>
                                <div id="submenu-8" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{URL::to('/dsdonhang')}}">Đơn Hàng Chờ Xác Nhận</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{URL::to('/dshoadonban')}}">Hóa Đơn Bán</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{URL::to('/dsdonhuy')}}">Đơn Hàng Đã Hủy</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{URL::to('/danh-sach-hoa-don-nhap')}}" data-toggle="" aria-expanded="false" data-target="#submenu-9" aria-controls="submenu-9"><i class="fas fa-fw fa-map-marker-alt"></i>Quản Lý Hóa Đơn Nhập</a>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{URL::to('/danh-sach-hang')}}" data-toggle="" aria-expanded="false" data-target="#submenu-10" aria-controls="submenu-10"><i class="fas fa-f fa-folder"></i>Quản Lý Hãng</a>
    ...
    <script>
        $('.tinh_trang').change(function(){
            var tinhtrang = $(this).val();
            var mahdb = $(this).children(":selected").attr("id");
            var trangthai = "Đã thanh toán";
            //alert(tinhtrang);
            //alert(mahdb);
            if (mahdb && tinhtrang === "DangGiao") {

            // Sử dụng Ajax để gửi yêu cầu cập nhật
            axios.post('/updatetinhtrang', {
                maHDB: mahdb,
                tinhTrang: 'Đang giao hàng',
            });
            location.reload();
            }
            if (mahdb && tinhtrang === "DaGiao") {
            axios.post('/updatetinhtrang1', {
                maHDB: mahdb,

                           ...
                           <!-- Product Details Left -->
                            ...
                            <div class="product-details-left">
                                ...
                                <div class="product-details-images slider-navigation-1">
                                    <div class="lg-image">
                                        <a class="popup-img venobox vbox-item" href="images/product/large-size/9.jpg" data-gall="myGallery">
                                            <img src="{{URL:: to('fontend/images/'.$chitietsp[0]->AnhDaiDien)}}" alt="product image">
                                        </a>
                                    </div>

                                    <div class="lg-image">
                                        <a class="popup-img venobox vbox-item" href="images/product/large-size/2.jpg" data-gall="myGallery">
                                            <img src="{{URL:: to('fontend/images/'.$chitietsp[0]->AnhLienQuan)}}" alt="product image">
                                        </a>
                                    </div>
                                    {{-- <div class="lg-image">
                                ...
                                <div class="product-details-thumbs slider-thumbs-1">
                                    <div class="sm-image"><img src="{{URL:: to('fontend/images/'.$chitietsp[0]->AnhDaiDien)}}" alt="product image thumb"></div>
                                    @foreach ($chitietsp as $key => $item)
                                        <div class="sm-image"><img src="{{URL:: to('fontend/images/'.$item->AnhLienQuan)}}" alt="product image thumb"></div>
                                    @endforeach
                            ...
                            <div class="product-details-view-content pt-60">
                                <div class="product-info">
                                    ...
                                    <div class="price-box pt-20">
                                        <span class="new-price new-price-2">Vui lòng chọn option để biết giá</span>
                                    </div>
                                    ...
                                    <div class="product-additional-info pt-25">
                                        <a class="wishlist-btn" href="wishlist.html"><i class="fa fa-heart-o"></i>Thêm vào yêu thích</a>

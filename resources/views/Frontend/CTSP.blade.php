                ...
                <div class="col-lg-5 col-md-6">
                    ...
                    <div class="product-details-left">
                        ...
                        <div class="product-details-images slider-navigation-1">
                            <div class="lg-image">
                                <a class="popup-img venobox vbox-item" href="images/product/large-size/9.jpg"
                                    data-gall="myGallery">
                                    <img src="{{ URL::to('fontend/images/' . $chitietsp[0]->AnhDaiDien) }}"
                                        alt="product image">
                                </a>
                            </div>
                        ...
                        <div class="product-details-thumbs slider-thumbs-1">
                            <div class="sm-image"><img src="{{ URL::to('fontend/images/' . $chitietsp[0]->AnhDaiDien) }}"
                                    alt="product image thumb"></div>
                            @foreach ($chitietsp as $key => $item)
                                <div class="sm-image"><img src="{{ URL::to('fontend/images/' . $item->AnhLienQuan) }}"
                                        alt="product image thumb"></div>
                            @endforeach

                            {{-- <div class="sm-image"><img src="images/product/small-size/10.jpg" alt="product image thumb"></div>
                                    <div class="sm-image"><img src="images/product/small-size/12.jpg" alt="product image thumb"></div> --}}
                        ...
                        <div class="product-info">
                            ...
                            <div class="price-box pt-20">
                                {{-- @foreach ($chitietsp as $key => $value)
                                    <span class="new-price new-price-2">{{ $ctsp->DonGiaBan }}</span>
                                @endforeach --}}
                                <span class="new-price new-price-2">{{ $ctsp->DonGiaBan }}</span>
                            </div>
                            ...
                            <div class="row">
                                <div class="product-variants col-lg-6 col-md-6">
                                    <div class="produt-variants-size">
                                        <label>Màu Sắc</label>
                                        <select class="nice-select" id="mauSacSelect">
                                            {{-- @foreach ($chitietsp as $key => $value) --}}
                                                {{-- <option {{ $ctsp->MaMau == $maMau ? 'selected' : '' }} id="{{ $ctsp->MaSP }}"
                                                    value="{{ $ctsp->MaMau }}" title="mau">{{ $ctsp->TenMau }}
                                                </option> --}}

                                            @foreach ($mauSP as $key => $value)
                                                <option id="{{ $item->MaSP }}" value="{{ $value->MaMau }}" title="mau">{{$value->TenMau}}</option>
                                            @endforeach
                                            {{-- @endforeach --}}
                                            {{-- <option value="1" title="S" selected="selected">Đen</option>
                                                    <option value="2" title="M">Đỏ</option>
                                                    <option value="3" title="L">Vàng</option> --}}
                                        </select>
                                    </div>
                                </div>
                                <div class="product-variants col-lg-6 col-md-6">
                                    <div class="produt-variants-size">
                                        ...
                                        <select class="nice-select" id="dungLuongSelect">
                                            {{-- @foreach ($chitietsp as $key => $value) --}}
                                                {{-- <option {{ $ctsp->MaDL == $maDL ? 'selected' : '' }} id="{{ $ctsp->MaSP }}"
                                                    value="{{ $ctsp->MaDL }}" title="S">{{ $ctsp->SoDL }}
                                                </option> --}}

                                                @foreach ($dlSP as $key => $value)
                                                        <option id="{{ $item->MaSP }}" value="{{ $value->MaDL }}" title="S">{{$value->SoDL}}</option>
                                                @endforeach
                                            {{-- @endforeach --}}
                                            {{-- <option value="1" title="S" selected="selected">32GB</option>
                                                    <option value="2" title="M">64GB</option>
                                                    <option value="3" title="L">128GB</option> --}}
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="rating-box pt-20">
                                {{-- @foreach ($chiTietSanPham as $key => $value) --}}
                                    <label style="font-weight:bold; color: orange;">Bạn đang chọn phiên bản:</label> <br>
                                    <span class="data-box">{{ $ctsp->TenMau }}</span> và
                                    <span class="data-box">{{ $ctsp->SoDL }}GB</span>
                                {{-- @endforeach --}}
                            </div>
                                ...
                                <form action="#" class="cart-quantity">
                                    {{-- <div class="quantity">
                                        ...
                                        <div class="cart-plus-minus">
                                            <input name="qty" min="1" class="cart-plus-minus-box{{$ctsp->MaCTSP}}" value="1" type="text">
                                            <div class="dec qtybutton"><i class="fa fa-angle-down"></i></div>
                                            <div class="inc qtybutton"><i class="fa fa-angle-up"></i></div>
                                        </div>
                                    </div> --}}
                                    <button class="add-to-cart" type="submit"><a href="{{ route('add_to_cart', $ctsp->MaCTSP)}}" role="button">
                                        Thêm Vào Giỏ Hàng
                                    </a></button>
                                </form>
                            </div>
                            <div class="product-additional-info pt-25">
                                @foreach ($chiTietSanPham as $key => $value)
                                    <a class="wishlist-btn" href="wishlist.html"><i class="fa fa-heart-o"></i>Thêm vào
                                        yêu thích</a>
                                @endforeach

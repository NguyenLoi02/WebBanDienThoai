...
<body>
 ...
 <![endif]-->
    ...
    <div class="body-wrapper">
        ...
        <div class="container">
            <h2 class="form-title">Đổi Mật Khẩu</h2>
            <br>
            @if (session('message'))
            ...
            <br>
            <br>
            <form action="{{ route('save_doimatkhau') }}" method="post">
                @csrf
                <div class="form-group">
                    <label for="ten-khach-hang">Mật Khẩu Cũ</label>
                    <input type="password" name="Password" id="ten-khach-hang" class="form-control">
                    @error('Password')
                ...
                <div class="form-group">
                    <label for="ngay-sinh">Mật Khẩu Mới</label>
                    <input type="password" name="New_Pass" id="ngay-sinh" class="form-control">
                    @error('New_Pass')
                        <span style="color: red">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    <label for="so-dien-thoai">Xác Nhận Mật Khẩu</label>
                    <input type="password" name="Confirm_Pass" id="so-dien-thoai" class="form-control">
                    @error('Confirm_Pass')
                        <span style="color: red">{{ $message }}</span>
                    @enderror
                </div>

                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="li-product-add-cart">Hủy đơn hàng</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($lichSuHDB as $item)
                                    <tr>
                                            ...
                                            <td class="li-product-add-cart"><a href="{{ route('chi_tiet_don_hang',[$item->MaHDB]) }}">Chi tiết</a></td>
                                            <td class="li-product-add-cart"><a href="{{ route('li_do_huy_don_hang',[$item->MaHDB]) }}">Hủy</a></td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>

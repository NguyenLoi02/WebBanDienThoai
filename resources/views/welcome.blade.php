                                                ...
                                                <ul class="minicart-product-list">
                                                    <li>
                                                        <a href="single-product.html" class="minicart-product-image">
                                                            <img src="{{asset('fontend/images/product/small-size/5.jpg')}}" alt="cart products">
                                                        </a>
                                                    ...
                                                    <li>
                                                        <a href="single-product.html" class="minicart-product-image">
                                                            <img src="{{asset('fontend/images/product/small-size/6.jpg')}}" alt="cart products">
                                                        </a>
                                                        <div class="minicart-product-details">
                                                            <h6><a href="single-product.html">Aenean eu tristique</a></h6>
                                                            <span>£40 x 1</span>
                ...
                <div class="container">
                    <div class="row">
                                ...
                                <div class="slider-active owl-carousel">
                                    ...
                                    <div class="single-slide align-center-left  animation-style-01 bg-1">
                                        ...
                                        <div class="slider-content">
                                            <h5>Giảm Giá <span>-20% </span> Trong Tuần Này</h5>
                                            <h2>Galaxy S9 | S9+</h2>
                                            <h3>Giá chỉ từ <span>10.000.000đ</span></h3>
                                    ...
                                    <div class="single-slide align-center-left  animation-style-01 bg-1">
                                        ...
                                        <div class="slider-content">
                                            <h5>Giảm Giá <span>-20% </span> Trong Tuần Này</h5>
                                            <h2>Galaxy S9 | S9+</h2>
                                            <h3>Giá chỉ từ <span>10.000.000</span></h3>
                                            <div class="default-btn slide-btn">
                                                <a class="links" href="shop-left-sidebar.html">Mua Ngay</a>
                                            </div>
                                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 text-center pt-xs-30">
                            <div class="li-banner">
                                <a href="#">
                                    <img src="{{asset('fontend/images/banner/banner1.jpg')}}" alt="">
                                </a>
                            </div>
                            <div class="li-banner mt-15 mt-sm-30 mt-xs-30">
                                <a href="#">
                                    <img src="{{asset('fontend/images/banner/banner1.2.jpg')}}" alt="">
                                </a>
                            </div>
                        </div>
                                                ...
                                                <div class="product_desc_info">
                                                    <div class="product-review">
                                                        <h5 class="manufacturer">
                                                            <a href="shop-left-sidebar.html">Iphone</a>
                                                        </h5>
                                                    ...
                                                    <h4><a class="product_name" href="single-product.html">Iphone 15</a></h4>
                                                    <div class="price-box">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 text-center">
                            <div class="single-banner">
                                <a href="#">
                                    <img src="{{asset('fontend/images/banner/baner2.png')}}" alt="Li's Static Banner">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 text-center pt-xs-30">
                            <div class="single-banner">
                                <a href="#">
                                    <img src="{{asset('fontend/images/banner/banner2.1.jpg')}}" alt="Li's Static Banner">
                                </a>
                            </div>
                        </div>
                        <!-- Single Banner Area End Here -->
                        ...
                        <div class="col-lg-4 col-md-4 text-center pt-xs-30">
                            <div class="single-banner">
                                <a href="#">
                                    <img src="{{asset('fontend/images/banner/banner2.2.jpg')}}" alt="Li's Static Banner">
                                </a>
                            </div>
                        </div>
                        <!-- Single Banner Area End Here -->
